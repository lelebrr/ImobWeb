  ...
  private static articles: Article[] = [
    {
      ...
      excerpt: 'Aprenda como configurar o perfil da sua imobiliária e convidar sua equipe.',
      category: 'Início',
      slug: 'primeiros-passos',
      content: 'Bem-vindo ao imobWeb! O primeiro passo é configurar sua organização...',
      tags: ['configuração', 'equipe', 'onboarding']
    },
    {
      id: '2',
      title: 'Dominando o WhatsApp Automático',
      excerpt: 'Entenda como funcionam as conversas inteligentes com proprietários.',
      category: 'WhatsApp',
      slug: 'whatsapp-automatico',
      content: 'O imobWeb utiliza IA para responder proprietários automaticamente...',
      tags: ['whatsapp', 'ia', 'automação']
    },
    {
      id: '3',
      title: 'Gestão de Imóveis e Publicação em Portais',
      excerpt: 'Como cadastrar um imóvel uma única vez e publicar em todos os portais.',
      category: 'Imóveis',
      slug: 'gestao-imoveis',
      content: 'Para cadastrar um imóvel, acesse o dashboard e clique em Novo Imóvel...',
