...
// Provider component for PostHog (Next.js App Router)
export function PostHogProvider({ children }: { children: React.ReactNode }) {
  useEffect(() => {
    // Only initialize on the client
    if (typeof window !== 'undefined' && !analytics.isInitialized) {
      // The constructor already handles init if conditions are met
    }
  }, []);
