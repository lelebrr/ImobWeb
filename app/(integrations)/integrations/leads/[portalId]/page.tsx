...
export default function PortalLeadsDashboard({ params }: PageProps) {
  ...
  const stats = MOCK_PORTAL_STATS[portalId] || {
    leads: 0,
    views: 0,
    contacts: 0,
    conversion: 0,
  ...
  const portalNames: Partial<Record<PortalId, string>> = {
    zap: "Zap Imóveis",
    viva: "Viva Real",
    olx: "OLX",
    imovelweb: "ImovelWeb",
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-bold text-gray-900">
            Leads - {portalNames[portalId]}
          </h2>
          <p className="text-gray-500">
            Gerencie os leads recebidos deste portal
          </p>
        </div>
