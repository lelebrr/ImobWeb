    ...
    <div className="p-8 space-y-8 bg-slate-950 min-h-screen text-slate-200">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-1">
            Bem-vindo, veja o resumo global do imobWeb hoje.
          </p>
        </div>
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-sm text-slate-500 mt-1">
                Performance consolidada de todas as organizações
              </p>
            </div>
        ...
        <div className="bg-slate-900/50 backdrop-blur-md border border-slate-800 p-8 rounded-[2rem] shadow-xl">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-sm text-slate-500 mt-1">
                Novos usuários ativos por período
              </p>
            </div>
      ...
      <div className="bg-slate-900/40 border border-slate-800 rounded-[2rem] p-8">
        <h3 className="text-lg font-bold text-white mb-6">
          Alertas Críticos & Atividade Recente
        </h3>
        <div className="space-y-4">
          {[
            {
              type: "billing",
              msg: "Falha no faturamento - Imobiliária Santos & Co",
              time: "2 min atrás",
              color: "rose",
            },
            {
              type: "portal",
              msg: "Sync incompleto com ZAP Imóveis (Token expidado)",
              time: "15 min atrás",
              color: "amber",
            },
            {
              type: "user",
              msg: "Novo ticket VIP: Erro no upload de tour 360",
              time: "1 hora atrás",
              color: "indigo",
            },
          ].map((log, i) => (
            <div
              key={i}
              className="flex items-center justify-between p-4 rounded-2xl bg-slate-900 border border-slate-800 hover:border-slate-700 transition-all cursor-pointer"
            >
