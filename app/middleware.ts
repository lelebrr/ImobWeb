...
import { protectRoute, protectAdminRoute, protectOrganizationRoute, securityHeaders } from '@/lib/middleware-helpers'
...
export async function middleware(request: NextRequest) {
    ...
    if (organizationId && organizationRoutes.some(route => pathname.startsWith(route))) {
