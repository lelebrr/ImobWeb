...
const CRM_MAPPINGS: Record<string, FieldMapping[]> = {
    'Tecimob': [
        { sourceField: 'Código', targetField: 'id', required: false },
        { sourceField: 'Título', targetField: 'title', required: true },
        { sourceField: 'Endereço', targetField: 'address', required: true },
        { sourceField: 'Bairro', targetField: 'neighborhood', required: false },
        { sourceField: 'CEP', targetField: 'cep', required: true },
        { sourceField: 'Número', targetField: 'number', required: false },
        { sourceField: 'Quartos', targetField: 'bedrooms', required: true },
        { sourceField: 'Banheiros', targetField: 'bathrooms', required: true },
        { sourceField: 'Vagas', targetField: 'parkingSpaces', required: false },
        { sourceField: 'Área', targetField: 'area', required: false },
        { sourceField: 'Preço', targetField: 'price', required: true },
        { sourceField: 'Telefone', targetField: 'phone', required: true },
        { sourceField: 'Email', targetField: 'email', required: false },
        { sourceField: 'Descrição', targetField: 'description', required: false },
        { sourceField: 'Status', targetField: 'status', required: false },
        { sourceField: 'Vendedor', targetField: 'seller', required: false },
        { sourceField: 'CPF/CNPJ', targetField: 'sellerCpfCnpj', required: false },
    ],
    'ImobTotal': [
        { sourceField: 'Código', targetField: 'id', required: false },
        { sourceField: 'Título', targetField: 'title', required: true },
