  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-background/85 backdrop-blur-md border-b flex items-center h-16 px-fluid-4 lg:px-fluid-6 gap-4 shrink-0 transition-all">
      ...
      <div className="flex items-center gap-2 sm:gap-4 ml-auto">
        ...
        {/* User Profile Avatar */}
        <div className="relative w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-primary/20 border-2 border-primary/10 flex items-center justify-center shrink-0 cursor-pointer overflow-hidden ring-offset-background hover:ring-2 hover:ring-primary/40 transition-all shadow-sm">
          <ImageOptimized
