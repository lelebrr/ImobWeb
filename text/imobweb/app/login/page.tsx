...
import { Mail, Lock, ArrowRight, Loader2, Zap, ShieldCheck, Globe } from 'lucide-react'
            ...
            <div className="w-full max-w-[1100px] grid grid-cols-1 lg:grid-cols-2 gap-8 items-center relative z-10">
                ...
                <div className="hidden lg:flex flex-col space-y-8 p-8">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-4xl font-black tracking-tighter text-gradient">imobWeb</span>
                    </div>
                    
                    <h1 className="text-5xl font-black tracking-tighter leading-none">
                        A Inteligência que seu <br />
                        <span className="text-primary italic">Negócio Imobiliário</span> merece.
                    </h1>
                    ...
                    <div className="space-y-6">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground font-medium">Cadastre 1x e publique em todos os portais automaticamente.</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-4">
                            <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center shrink-0">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground font-medium">Nossa IA atende seus leads em segundos, 24/7.</p>
                            </div>
                        </div>
                    </div>
                ...
                <Card className="glass border-none shadow-2xl overflow-hidden animate-in fade-in slide-in-from-right-8 duration-700">
                    <CardContent className="p-8 md:p-12">
                        ...
                        <div className="mb-8 text-center lg:text-left">
                            <h2 className="text-3xl font-black tracking-tighter">Login de Acesso</h2>
                            <p className="text-muted-foreground font-medium">Insira suas credenciais para gerenciar sua carteira.</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            <div className="space-y-2">
                                <Label htmlFor="email" className="font-black uppercase text-[10px] tracking-widest ml-1 text-muted-foreground">Email Profissional</Label>
                            ...
                            <div className="space-y-2">
                                <div className="flex justify-between items-center ml-1">
                                    <Label htmlFor="password" className="font-black uppercase text-[10px] tracking-widest text-muted-foreground">Senha Secreta</Label>
                                    <Link href="/forgot-password" title="Recuperar senha" className="text-[10px] font-black uppercase text-primary hover:underline">Esqueceu?</Link>
                                </div>
                                <div className="relative group">
