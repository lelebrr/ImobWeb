...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        // ============================================
        // FLUID TYPOGRAPHY MAPPING
        // Todas essas classes padrão do tailwind agora escalam usando clamp()
        // ============================================
        "xs": "var(--text-xs)",
        "sm": "var(--text-sm)",
        "base": "var(--text-base)",
      ...
      spacing: {
        // ============================================
        // FLUID SPACING MAPPING
        // ============================================
        "1": "var(--space-1)",
        "2": "var(--space-2)",
        "3": "var(--space-3)",
        "4": "var(--space-4)",
        "5": "calc(var(--space-4) * 1.25)",
        "6": "var(--space-6)",
        "8": "var(--space-8)",
        "10": "var(--space-10)",
        "12": "var(--space-12)",
        ...
        "20": "var(--space-20)",
        "24": "var(--space-24)",
        "32": "calc(var(--space-24) * 1.3)",
        "40": "calc(var(--space-24) * 1.6)",
        "48": "calc(var(--space-24) * 2)",
        "64": "calc(var(--space-24) * 2.5)",
      },
      height: {
        // ============================================
        // IA 4 - CUSTOM HEIGHTS
